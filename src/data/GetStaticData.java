...
public class GetStaticData {
    ...
    public static StaticData getStaticData(RiotApi api) throws RiotApiException {
        ChampionList championList = api.getDataChampionList(Region.NA, null, null, false, ChampData.ALL);
        ...
        SummonerSpellList summonerSpellList = api.getDataSummonerSpellList(Region.NA, null, null, false, SpellData.ALL);

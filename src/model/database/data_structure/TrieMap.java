...
public class TrieMap<K extends CharSequence, V> implements Trie.INodeCreator, IMap<K,V>, Serializable {

    private static final long serialVersionUID = -7308459979991904147L;

    protected TrieExtended<K> trie = null;

    public TrieMap() {
        trie = new TrieExtended<>(this);
    }
